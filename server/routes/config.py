...
def register_routes(app, deps):
    ...
    async def get_config():
        try:
            ...
            return _ok({
                ...
                "ai_reply_trigger_phrase": settings.get("ai_reply_trigger_phrase", ""),
                "ai_session_end_phrase": settings.get("ai_session_end_phrase", ""),
                "self_chat_user_prefix": settings.get("self_chat_user_prefix", ""),
                "ai_end_session_disables_ai": settings.get("ai_end_session_disables_ai", True),
    ...
    async def save_config(body: dict):
        ...
        allowed_keys = {
            ...
            "default_ai_enabled",
            "ai_reply_trigger_phrase", "ai_session_end_phrase", "self_chat_user_prefix",
            "ai_end_session_disables_ai",
            "automation_webhook_allowed_domains",
